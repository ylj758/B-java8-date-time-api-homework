...
public class MeetingSystemV3 {
  ...
  public static void main(String[] args) {
    ...
    // 从字符串解析得到会议时间
    LocalDateTime meetingTime = LocalDateTime.parse(timeStr, formatter).atZone(defaultZoneId).toLocalDateTime();
    ...
    if (now.isAfter(meetingTime)) {
      ...
      // 获取Chicago时区
      ZoneId zoneIdLondon = ZoneId.of("America/Chicago");
      ZonedDateTime zonedDateTime = meetingTime.atZone(zoneIdLondon);
      // 格式化新会议时间
